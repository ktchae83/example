...
public class Example04 {
    private static final String YOUTUBE_ID = "admin";
    private static final String YOUTUBE_PW = "0000";

    public static void main(String[] args) {
        String inputID = "";
        String inputPW = "";
        String inputCaption = "";
        final String[] strNotAllowedWords = {"킹", "시발", "꺼저", "미친"};
        final String[] strChangedWords = {"열", "사랑", "행운", "희망"};
...
//        }};
        ...
        System.out.println("========================================");
        System.out.print("[");
        System.out.print(Arrays.toString(strNotAllowedWords));
        System.out.println("]");
        System.out.println("========================================");

        System.out.println("[알림] 자막 순화 프로그램 결과입니다.");
        for (int i = 0; i<strNotAllowedWords.length; i++) {
            inputCaption = inputCaption.replace(strNotAllowedWords[i], strChangedWords[i]);
        }
        System.out.printf(">>> %s\n", inputCaption);
